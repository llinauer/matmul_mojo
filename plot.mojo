...
def main(): 
    ...
    plt.plot(Python.list(matrix_sizes), Python.list(numpy_times), label="Python (NumPy)") 
    plt.plot(Python.list(matrix_sizes), Python.list(matmul_v1_times), label="Mojo matmul_v1") 
    plt.plot(Python.list(matrix_sizes), Python.list(matmul_v2_times), label="Mojo matmul_v2") 
    plt.plot(Python.list(matrix_sizes), Python.list(matmul_v3_times), label="Mojo matmul_v3 (flattened)") 
    plt.plot(Python.list(matrix_sizes), Python.list(matmul_v4_times), label="Mojo matmul_v4 (flattened + SIMD)") 
